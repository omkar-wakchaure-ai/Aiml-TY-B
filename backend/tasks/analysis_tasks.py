...
def create_analysis_task(analyst_agent, gathering_task, target_topic):
    ...
    return Task(
        description=(
            ...
            "4. If evidence conflicts, state the conflict explicitly rather than guessing. "
            "If data is insufficient or missing, refuse unsupported conclusions and output "
            "'Low Confidence / Insufficient Data'."
        ),
        expected_output=(
            "A structured markdown report with the top 3 sourced insights, impact scores, "
            "confidence percentages, conflict notes, groundedness notes, and a strategic "
            "recommendation. Include 'Low Confidence / Insufficient Data' when appropriate."
        ),
        agent=analyst_agent,
